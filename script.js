    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "رواق اليكينة uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'f775e2c3-d3b8-4670-9d48-801295403f02',
                    name: data.name || '',
                    email: data.email || '',
